...
public static class DiffReportWriterJsonExtensions
{
	...
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="writer"/> or <paramref name="result"/> is <see langword="null"/></exception>
	...
	/// <exception cref="ArgumentNullException"><paramref name="json"/> or <paramref name="detector"/> is <see langword="null"/></exception>
	...
	/// <exception cref="ArgumentNullException"><paramref name="json"/> or <paramref name="detector"/> is <see langword="null"/></exception>
	public static bool TryFromJson(string json, SensitiveKeyDetector detector, out DiffResult? value, bool showSecrets = false)
	{
		value = null;
